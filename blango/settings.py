...
class Dev(Configuration):  
    ...
    # Changes to allow codio run django
    ...
    # Custom User has no username Add settings to help
    ACCOUNT_USER_MODEL_USERNAME_FIELD = None # No username on the field
...
class Prod(Dev):
  ...
  #raises exception if a default value is set to prevent from accidentally using a committed value
